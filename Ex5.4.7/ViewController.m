...
-(NSString *)getuPullPath:(NSString *)fileName
{
...
- (void)startRecording
{
    ...
    NSString *filePath = [self getuPullPath:[NSString stringWithFormat:@"%@.caf",[date description]]];
    NSLog(@"aaa:%@",[date description]);
...
- (IBAction)toggleRecoding:(id)sender
{
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *fullPath = [self getuPullPath:fileName];
    NSFileManager *fm = [NSFileManager defaultManager];
